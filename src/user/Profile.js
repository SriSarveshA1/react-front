...
class Profile extends Component {
    ...
    componentWillReceiveProps(props) {//so when ever this component receives new props that is new userid as a parameter this method will be called
                ...
                <div className="row">
                    ...
                    <div className="col-md-6">
                        <div className="lead mt-2">
                            ...
                            <p>{`Joined ${new Date(
                                user.created
                            ).toDateString()}`}</p>{/*we are printing the date when the user joined*/}
                        </div>
                        ...
                        &&  isAuthenticated().user._id === user._id && (
                                <div className="d-inline-block">
                                    ...
                                    <Link //</div>* so when the user is click this Edit Profile the `/user/edit/${this.state.user._id}` with the userid will be in the url and the edit profile route will be rendered*/}
